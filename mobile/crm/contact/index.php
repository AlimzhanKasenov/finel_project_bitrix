	...
	case "view":
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				"CONTACT_EDIT_URL_TEMPLATE" => SITE_DIR."mobile/crm/contact/?page=edit&contact_id=#contact_id#",
				"COMPANY_SHOW_URL_TEMPLATE" => SITE_DIR."mobile/crm/company/?page=view&company_id=#company_id#",
				"ACTIVITY_LIST_URL_TEMPLATE" => SITE_DIR."mobile/crm/activities/list.php?entity_type_id=#entity_type_id#&entity_id=#entity_id#",
				"ACTIVITY_EDIT_URL_TEMPLATE" => SITE_DIR."mobile/crm/activities/edit.php?owner_type=#owner_type#&owner_id=#owner_id#&type_id=#type_id#",
