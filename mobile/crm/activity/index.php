...
{
	case "list":
		$APPLICATION->IncludeComponent('bitrix:mobile.crm.activities.list', '', array(
			'GRID_ID' => 'mobile_crm_activity_list',
			"ITEM_PER_PAGE" => 20,
			'ACTIVITY_VIEW_URL_TEMPLATE' => SITE_DIR.'mobile/crm/activities/?page=view&activity_id=#activity_id#',
			'ACTIVITY_EDIT_URL_TEMPLATE' => SITE_DIR.'mobile/crm/activities/?page=edit&activity_id=#activity_id#',
			'ACTIVITY_CREATE_URL_TEMPLATE' => SITE_DIR.'mobile/crm/activities/?page=edit',
	...
	case "edit":
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				'LEAD_VIEW_URL_TEMPLATE' => SITE_DIR.'mobile/crm/activities/view.php?activity_id=#activity_id#',
			)
		);
		break;
	case "view":
		$APPLICATION->IncludeComponent(
			...
			array(
				...
				'COMPANY_SHOW_URL_TEMPLATE' => SITE_DIR.'mobile/crm/company/?page=view&company_id=#company_id#',
				'CONTACT_SHOW_URL_TEMPLATE' => SITE_DIR.'mobile/crm/contact/?page=view&contact_id=#contact_id#',
				'LEAD_EDIT_URL_TEMPLATE' => SITE_DIR.'mobile/crm/activities/edit.php?activity_id=#activity_id#',
			)
		);
		break;
}
